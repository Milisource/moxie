...
export function CacheCover(arg1:number,arg2:string):Promise<string>;
...
export function GetCachedCover(arg1:number):Promise<string>;
...
export function GetCoverPath(arg1:number):Promise<string>;
